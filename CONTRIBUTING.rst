...
Welcome to ``merge-excel`` contributor's guide.
...
If you experience bugs or general issues with ``merge-excel``, please have a look
...
You can help improve ``merge-excel`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``merge-excel`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``merge-excel``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/merge-excel.git
    cd merge-excel
...
#. Install |pre-commit|_::
   ...
   ``merge-excel`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/merge-excel
.. _issue tracker: https://github.com/<USERNAME>/merge-excel/issues
.. <-- end -->
